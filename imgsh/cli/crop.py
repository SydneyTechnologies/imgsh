...
from imgsh.utils.validation import validate_crop_box, validate_ocr_options, validate_quality
...
def register(app: typer.Typer) -> None:
    ...
    def crop_command(
        ...
        x: Annotated[
            int,
            typer.Option("--x", help="Crop start x-coordinate in pixels from the left edge."),
        ],
        y: Annotated[
            int,
            typer.Option("--y", help="Crop start y-coordinate in pixels from the top edge."),
        ],
        width: Annotated[int, typer.Option("--width", help="Crop width in pixels.")],
        height: Annotated[int, typer.Option("--height", help="Crop height in pixels.")],
        out: Annotated[
